...
- SPA **React + Vite** (`frontend/`). Despliegue con `amplify.yml` (appRoot `frontend`, `npm ci` + `npm run build`, artefactos `dist`).
- Reescritura SPA: `frontend/amplify-rewrites.json` (200 → `/index.html`).
