    ...
    {p ? <div className="detail">
      ...
      <section>
        ...
        {p.stock > 0 && <div className="purchase-box">
          ...
          <button className="button" onClick={agregarAlCarrito}>Agregar al carrito · {money(p.precio * cantidad)}</button>
          {mensajeCompra && <p className="success">{mensajeCompra} <Link to="/carrito"><u>Ver carrito</u></Link></p>}
        </div>}
